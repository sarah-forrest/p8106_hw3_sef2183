...
![](p8106_hw3_sef2183_files/figure-gfm/unnamed-chunk-13-2.png)<!-- -->

The AUC for the GLM model is 0.963, indicating that the prediction
performance is very good. The misclassification error rate is \[\].

The AUC for the MARS model is slightly lower, at 0.943. Although lower
than the GLM model, this AUC indicates that the prediction performance
is very good for the MARS model as well. The misclassification error
rate is \[\].
